...
INSERT INTO ogrenciler7 VALUES ('1234567', 'GULCAN', 'SAHINBAS',75.5,now());
INSERT INTO ogrenciler7 VALUES ('1234568', 'ALI', 'VELI', 75.5,now());
INSERT INTO ogrenciler7 (ogrenci_no,soyisim,not_ort) VALUES('1234569', 'GULCAN',85.5); --NOT NULL kisitlamasi olduğu için bu veri eklenemez
...
“isim” i Unique, “maas” i Not Null yapın.“adresler” isminde baska bir tablo olusturun.Icinde “adres_id”, “sokak”, “cadde” ve “sehir”
...
-- Calisanlar tablosundan maasi 5000 den buyuk ollanlari listeleyiniz
SELECT isim FROM calisanlar WHERE maas>5000;


-- Calisanlar tablosundan Veli Han olan verileri listeyiniz

SELECT * FROM calisanlar WHERE isim='Veli Han';

-- Calisanlardan tabosunda maasi 5000 olan tum verileri listeleyiniz
SELECT * FROM calisanlar WHERE maas=5000;

--DDELETE FROM calisanlar; -- Eğer parent tablo başka bir child tablo ile iliskili ise önce child tablo silinmelidir
